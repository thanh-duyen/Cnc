...
#define Z_SERVO_PIN             GPIO_NUM_25
...
#define DEFAULT_HOMING_DIR_MASK ((0<<Z_AXIS) | (1<<Y_AXIS) | (1<<X_AXIS)) // move positive dir Z, negative X,Y
...
#define DEFAULT_X_STEPS_PER_MM 12.5
#define DEFAULT_Y_STEPS_PER_MM 12.5
...
#define CONNECT_TO_SSID "MyWifi"
#define SSID_PASSWORD "embedded"
